...
export const MODELS=[
 {id:'copilot_base',version:'v02',url:'/TowerDefense/runtime/copilot_base_v02.glb',clip:'work'},
 {id:'bert_breugelmans',version:'v01',url:'/TowerDefense/runtime/bert_breugelmans.glb',clip:'work'},
 {id:'github_octocat_classic_lowpoly',version:'v01',url:'/TowerDefense/runtime/github_octocat_classic_lowpoly.glb',clip:'idle'},
 {id:'copilot_developer',version:'v01',url:'/TowerDefense/runtime/copilot_developer.glb',clip:null},
 {id:'copilot_rubber_duck',version:'v01',url:'/TowerDefense/runtime/copilot_rubber_duck.glb',clip:null},
 {id:'copilot_shield',version:'v01',url:'/TowerDefense/runtime/copilot_shield.glb',clip:null},
 {id:'golden_compiler',version:'v01',url:'/TowerDefense/runtime/golden_compiler.glb',clip:'work'},
 {id:'copilot_commit_halo',version:'v01',url:'/TowerDefense/runtime/copilot_commit_halo.glb',clip:'work'},
 {id:'linter_agent',version:'v01',url:'/TowerDefense/runtime/linter_agent.glb',clip:null},
 {id:'problem_bug',version:'v01',url:'/TowerDefense/runtime/problem_bug.glb',clip:'move',enemy:true,speedFactor:1.25},
 {id:'problem_vague_spec',version:'v01',url:'/TowerDefense/runtime/problem_vague_spec.glb',clip:'move',enemy:true,speedFactor:.75},
 {id:'problem_missing_details',version:'v01',url:'/TowerDefense/runtime/problem_missing_details.glb',clip:'move',enemy:true,speedFactor:1}
];
