...
const specs=[
 ...
 ['copilot_architect','Architect',['#39868A','#28656B','#F2E8D5','#394850','#051F28','#058DAD','#05EAF0','#F4B856'],'Heavy teal block shell, cream square goggles and open handle arch, corner bumpers, gold side pivots and top instrument.'],
...
for(const [id,name,colors,brief] of specs){
 ...
 m.overrides=[{field:'contract.dimensions',reason:'Use the existing 1.8 m Base Copilot family scale. Architect and Developer have taller silhouette details; Linter is intentionally squat.'}];
