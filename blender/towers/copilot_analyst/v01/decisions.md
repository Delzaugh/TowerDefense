...
- Selected design: Squarish ivory shell, teal round spectacles, inset top panel, side requirements paper and orange edit pencil.
...
- Delivered revision 4: 2488 triangles, two opaque materials, one embedded 32×4 image used by two sampler bindings.
